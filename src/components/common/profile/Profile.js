...
const Profile = ({ patientProfile }) => {
  ...
  useEffect(() => {
    getProfilePic(patientProfile?._id).then((response) => {
      setImg(response);
    });
  }, [patientProfile]);
      ...
      <div className="lg:flex px-4">
        <div className="lg:flex gap-11">
          <div className="flex justify-center">
            <img
              src={
                patientProfile?.profilePicture ? img : "/default_pro_pic.png"
              }
          ...
          <div>
            <dl>
              <div class="px-4 py-2 grid grid-cols-2 sm:grid-cols-3 sm:gap-4 sm:px-6">
