...
import Switch2 from "../../../../common/Switch/Switch2";
...
import activepng1 from "../../../../../img/1 (Active).png";
import png2 from "../../../../../img/2.png";
import activepng2 from "../../../../../img/2 (Active).png";
import png3 from "../../../../../img/3.png";
import activepng3 from "../../../../../img/3 (Active).png";
import pngG from "../../../../../img/G.png";
import activepngG from "../../../../../img/G (Active).png";
import upInch from "../../../../../img/Up Arrow (Red).png";
import activeupInch from "../../../../../img/Up Arrow (Green).png";
import downInch from "../../../../../img/Down arrow (Red).png";
import activedownInch from "../../../../../img/Down Arrow (Green).png";
import light from "../../../../../img/Red.png";
import acitvelight from "../../../../../img/Red (2).png";
...
const CustomerDetails = ({ details, prescriptionDetails }) => {
  ...
  useEffect(() => {
    if (device_imei) {
      ...
      const intervalId = setInterval(fetchData, 2000); // Call every 2 seconds
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex flex-col h-[-80%]">
        ...
        <div className="">
          ...
          <div className="flex flex-wrap justify-center mb-1">
            <div className="flex flex-wrap justify-center mb-2">
              ...
              {customerProfile.floors > 1 ? (
                <div className="w-full sm:w-auto bg-white shadow-md rounded-lg px-4 py-2 mx-2 my-1 hover:shadow-lg flex flex-col items-center">
                  ...
                  <div className="text-bodyBB">{liftdata.d34}</div>
                </div>
              ) : null}
              {customerProfile.floors > 2 ? (
                <div className="w-full sm:w-auto bg-white shadow-md rounded-lg px-4 py-2 mx-2 my-1 hover:shadow-lg flex flex-col items-center">
                  <div
                    className="bg-red-500 text-bodyBB px-4 py-2"
                    style={{ whiteSpace: "nowrap" }}
                  ...
                  <div className="text-bodyBB">{liftdata.d36}</div>
                </div>
              ) : null}
            ...
            <div className="w-full sm:w-auto bg-white shadow-md rounded-lg px-4 py-2 mx-2 my-1 hover:shadow-lg flex flex-col items-center">
              ...
              <div className="text-bodyBB">{liftdata.d57}</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-around mb-1">
          <div className="flex flex-wrap justify-center mb-2">
            <div className="flex">
              ...
              {customerProfile.floors > 2 ? (
                <img
                  src={liftdata.d47 === "1" ? activepng3 : png3}
                  // src={png1} // Use the imported image variable
                  alt="Floor Usage" // Alternative text for screen readers
                  className="px-4 py-2 mx-2 my-1 w-24 h-24"
                  style={{ width: "100px", height: "100px" }} // Set width and height
                  onMouseDown={() => handleFloorButtonClick("v4", 1)} // Send 1 when pressed
                  onMouseUp={() => handleFloorButtonClick("v4", 0)} // Send 0 when released
                />
              ) : null}
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center mb-2">
            <div className="flex">
              <img
                ...
                onTouchStart={() => handleFloorButtonClick("v5", 1)}
                onTouchEnd={() => handleFloorButtonClick("v5", 0)}
              ...
              <img
                ...
                onTouchStart={() => handleFloorButtonClick("v6", 1)}
                onTouchEnd={() => handleFloorButtonClick("v6", 0)}
                onContextMenu={(e) => e.preventDefault()} // Prevent the context menu
              />{" "}
            </div>
          </div>
            ...
            <div className="flex">
              <button
                ...
                style={{
                  ...
                  height: "100px",
                  backgroundImage: `url(${
                    liftdata.d4 === "1" ? activeupInch : upInch
                  })`,
                ...
                // onMouseDown={() => handleFloorButtonClick("v5", 1)}
                // onMouseUp={() => handleFloorButtonClick("v5", 0)}
                onTouchStart={() => handleFloorButtonClick("v5", 1)}
                onTouchEnd={() => handleFloorButtonClick("v5", 0)}
                onContextMenu={(e) => e.preventDefault()} // Prevent the context menu
              ></button>
              <button
                ...
                style={{
                  ...
                  height: "100px",
                  backgroundImage: `url(${
                    liftdata.d5 === "1" ? activedownInch : downInch
                  })`,
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                  border: "none",
                ...
                // onMouseDown={() => handleFloorButtonClick("v6", 1)}
                // onMouseUp={() => handleFloorButtonClick("v6", 0)}
                onTouchStart={() => handleFloorButtonClick("v6", 1)}
                onTouchEnd={() => handleFloorButtonClick("v6", 0)}
                onContextMenu={(e) => e.preventDefault()} // Prevent the context menu
              ></button>
          ...
          {/* <div className="flex flex-wrap justify-center mb-2">
            <div className="flex items-start">
              <button
                className="px-4 py-2 mx-2 my-1 mt-2"
                style={{
                  width: "100px",
                  height: "100px",
                  backgroundImage: `url(${
          ...
          {customerProfile.floors > 2 ? (
            <div className="px-4 py-2 mx-2 my-1 h-14 flex items-center justify-between">
              <Button
                ...
                onClick={() => {
                  console.log("Mouse down event occurred3");
                  handleFloorButtonClick("v11", 1);

                  // After 300 milliseconds, execute handleFloorButtonClick("v8", 0)
                  setTimeout(() => {
                    console.log("Mouse down event occurred4");
                    handleFloorButtonClick("v11", 0);
                  }, 300);
                }}
              >
                3-FLOOR DOOR OPEN
          ...
          {/* <div className="flex flex-wrap justify-around mb-1">
            ...
            <div className="flex justify-between bg-white rounded-15 shadow-card items-center pl-8 p-5 my-1 h-14">
              <div className="text-bodyRB text-darkgrey mr-3">CHILD LOCK</div>
              <div className="flex gap-3 items-center">
                <Switch1
                  isOn={liftdata.d12 === "1"}
                  handleClick={() => {
          ...
          <div className="flex flex-wrap justify-around mb-1 bg-gray-1000">
            {/* <div className="flex justify-between bg-white rounded-15 shadow-card items-center pl-4 pr-4 p-5 my-1 h-14 w-full">
              <div className="text-bodyRB text-darkgrey mr-3">
                GROUND FLOOR DOOR STATUS
              </div>
              <div className="flex gap-3 items-center">
                {liftdata.d52 === "0" ? "CLOSED" : "OPENED"}
              </div>
            ...
            <div className="flex justify-between bg-white rounded-15 shadow-card items-center pl-4 pr-4 p-5 my-1 h-14 w-full">
              ...
              <div className="flex gap-3 items-center">
                <span style={{ color: liftdata.d52 === "0" ? "red" : "green" }}>
                  {liftdata.d52 === "0" ? "CLOSED" : "OPENED"}
                </span>
              </div>
            </div>
            ...
            {customerProfile.floors > 0 && (
              <div className="flex justify-between bg-white rounded-15 shadow-card items-center pl-4 pr-4 p-5 my-1 h-14 w-full">
                ...
                <div className="flex gap-3 items-center">
                  <span
                    style={{ color: liftdata.d53 === "0" ? "red" : "green" }}
                  >
                    {liftdata.d53 === "0" ? "CLOSED" : "OPENED"}
                  </span>
                </div>
            ...
            {customerProfile.floors > 1 && (
              <div className="flex justify-between bg-white rounded-15 shadow-card items-center pl-4 pr-4 p-5 my-1 h-14 w-full">
                ...
                <div className="flex gap-3 items-center">
                  <span
                    style={{ color: liftdata.d54 === "0" ? "red" : "green" }}
                  >
                    {liftdata.d54 === "0" ? "CLOSED" : "OPENED"}
                  </span>
                </div>
            ...
            {customerProfile.floors > 2 && (
              <div className="flex justify-between bg-white rounded-15 shadow-card items-center pl-4 pr-4 p-5 my-1 h-14 w-full">
                ...
                <div className="flex gap-3 items-center">
                  <span
                    style={{ color: liftdata.d55 === "0" ? "red" : "green" }}
                  >
                    {liftdata.d55 === "0" ? "CLOSED" : "OPENED"}
                  </span>
                </div>
        ...
        <div className="flex justify-around mb-1 min-h-[50px]">
          <h1 className="text-bodyBB"> </h1>
        </div>
