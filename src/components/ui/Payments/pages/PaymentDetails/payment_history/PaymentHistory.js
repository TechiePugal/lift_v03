...
const PendingInvoices = ({
 ...
 console.log(editInfo,"editinfo bug")
 console.log(details,"details entevaka")
  ...
  return (
    <div>
      <div className=" ">
        {/* <div
          className={`shadow-card rounded-tl-15 rounded-tr-15 bg-secondary sticky top-0 p-3 text-bodyBB text-darkgrey mb-2`}
        >
          Pending Bills
        </div> */}
      ...
      >
        <div className="md:w-[500px] lg:w-[1000px]">
          ...
          <PaymentInfo formik={formik} edit={true} details={editInfo}  history={true}   />
