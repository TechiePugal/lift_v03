...
const PaymentInfo = ({ formik, edit, details, history, discountInput }) => {
  ...
  const calculateAmounts = (
    ...
    return { amountPaid, appliedDiscount };
  };
    ...
    <div className="shadow-card rounded-15">
      ...
      <div className="lg:flex  justify-around p-5">
        <div className="grid lg:grid-cols-2 gap-3 ">
          ...
          <div className="">
            <p className="text-bodySB text-darkgrey pb-1">
              Bank Transfer
            </p>
            <InputBox
              type={"number"}
        ...
        <div className="border-r-2 border-[#B9B9B9] hidden lg:block"></div>
        <div className="border-b-2 border-[#B9B9B9] block lg:hidden mt-2 mb-2"></div>
        {/*  */}
        <div className="grid lg:grid-cols-2 gap-3 h-fit">
          {!history &&  (
            <div>
          ...
          <div>
            <p className="text-bodySB text-darkgrey pb-1">Total Amount</p>
            <InputBox
              type={"number"}
              name={`total_amount`}
