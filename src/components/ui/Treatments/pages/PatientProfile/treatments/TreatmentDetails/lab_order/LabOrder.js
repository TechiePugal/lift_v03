...
const LabOrder = ({ formik, addRow, removeRow, labs, labsWorks }) => {
  return (
    <div>
      <div className="">
              ...
              {formik?.values?.lab_info?.map((item, index) => (
                <tr key={index} className="text-center">
                  ...
                  <td className="border-b-2 pr-1 w-[190px] lg:min-w-full min-w-[190px] max-w-min">
                    <SelectionInput
                      placeholder={formik?.values?.lab_info?.[index]?.lab}
                      className={""}
                      onChange={(e) =>
                        formik.setFieldValue(`lab_info.${index}.lab`, e)
                      }
                      error={
                        formik.touched?.lab_info?.[index]?.lab &&
                        formik.errors?.lab_info?.[index]?.lab
                      }
                    >
                      {labs?.map((lab, index) => {
                        return (
                  ...
                  <td className="border-b-2 pr-5 w-[190px] lg:min-w-full min-w-[190px] max-w-min">
                    <SelectionInput
                      placeholder={formik?.values?.lab_info?.[index].work_type}
                      className={""}
                      onChange={(e) =>
                        formik.setFieldValue(`lab_info.${index}.work_type`, e)
                      }
                      error={
                        formik.touched.lab_info?.[index]?.work_type &&
                        formik.errors.lab_info?.[index]?.work_type
                      }
                    >
    ...
    <div className="flex">
      <div className="">
        <InputBox
          ...
          value={formik?.lab_info?.[index]?.teeth1}
          onChange={formik?.handleChange}
          error={
        ...
        <InputBox
          ...
          value={formik?.lab_info?.[index]?.teeth3}
          onChange={formik?.handleChange}
          error={
      ...
      <div>
        <InputBox
          ...
          value={formik?.lab_info?.[index]?.teeth2}
          onChange={formik?.handleChange}
          error={
        ...
        <InputBox
          ...
          value={formik?.lab_info?.[index].teeth4}
          onChange={formik?.handleChange}
          error={
