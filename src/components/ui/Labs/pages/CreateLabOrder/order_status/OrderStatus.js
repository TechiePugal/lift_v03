            ...
            <div className="">
              <DatePicker
                ...
                onDateChange={(e) => {
                  ...
                  if (formik?.values?.arrival_date < e) {
                    formik.setFieldValue("arrival_date", "");
                    formik.setFieldValue("fixing_date", "");
                  }
                }}
                startDate={formik.values.order_date}
            ...
            <div className="">
              <DatePicker
                ...
                onDateChange={(e) => {
                  ...
                  if (formik?.values?.fixing_date < e) {
                    formik.setFieldValue("fixing_date", "");
                    formik.setFieldValue("status", "Arrived");
                  }
                }}
                minDate={formik.values.order_date}
                startDate={formik?.values?.arrival_date}
                handleClear={() => {
                  formik.setFieldValue("arrival_date", "");
                  formik.setFieldValue("status", "Ordered");
                }}
          ...
          <div className="">
            ...
            <div className="">
              <DatePicker
                ...
                startDate={formik?.values?.fixing_date}
                minDate={formik?.values?.arrival_date}
                handleClear={() => {
                  formik.setFieldValue("fixing_date", "");
          ...
          <div className="text-center ">
            ...
            <div>
              ...
              >
                ...
                <option value="Arrived" className="">
                  Arrived
                </option>
